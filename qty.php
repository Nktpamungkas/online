...
<head>
	<meta charset="UTF-8">
	<title>quantity per buyer :: online system</title>
                ...
                <tr>
                  <td><form id="form1" name="form1" method="post" action="?">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normal9black">
                        ...
                        <tr>
                          <td class="blod9black">Nama Buyer </td>
...
$countBuyer = sqlsrv_num_rows($qryBuyer);
		...
		if ($countBuyer > 0 ){
			...
			while($rowBuyer=sqlsrv_fetch_array($qryBuyer)){
				...
				echo "<option value='$IDBuyer'>$NamaBuyer </option>";
				echo "</select";
			}
		}	
			//--
...
$kodebuyer=$_POST['kodebuyer'];

if (($nohanger <> '') || ($kodebuyer <> '')){
