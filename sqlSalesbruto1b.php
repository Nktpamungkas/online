...
$sql0="select
		...
		from
			...
			where so.SalesPersonCode='$kodebuyer' and soda.GrossWeight > '1000' $jod
				group by
...
$sql0="select
		...
		from
			...
			from
				...
				SODetailsAdditional soda on sod.ID = soda.SODID 
			--where so.BuyerID='$idBuyer' --and so.SODate between '$tgl1' and '$tgl2'
			where so.SalesPersonCode='$kodebuyer' and soda.GrossWeight between '1' and '24' $jod
				group by
					so.SONumber, so.SODate, so.CustomerID, so.BuyerID, so.PONumber, so.PODate,jo.DocumentNo,
					sod.ID, sod.ProductID, sod.Quantity, sod.UnitID, sod.Weight, sod.WeightUnitID,
					soda.RefNo,
...
$sql0="select
		...
		from
			...
			from
				...
				SODetailsAdditional soda on sod.ID = soda.SODID 
			--where so.BuyerID='$idBuyer' --and so.SODate between '$tgl1' and '$tgl2'
			where so.SalesPersonCode='$kodebuyer' and soda.GrossWeight > '1' $jod
				group by
					so.SONumber, so.SODate, so.CustomerID, so.BuyerID, so.PONumber, so.PODate,jo.DocumentNo,
					sod.ID, sod.ProductID, sod.Quantity, sod.UnitID, sod.Weight, sod.WeightUnitID,
					soda.RefNo,
...
$sql0="select
		...
		from
			...
			from
				...
				SODetailsAdditional soda on sod.ID = soda.SODID 
			--where so.BuyerID='$idBuyer' --and so.SODate between '$tgl1' and '$tgl2'
			where so.SalesPersonCode='$kodebuyer' and soda.GrossWeight between '$r1' and '$r2' $jod
				group by
					so.SONumber, so.SODate, so.CustomerID, so.BuyerID, so.PONumber, so.PODate,jo.DocumentNo,
					sod.ID, sod.ProductID, sod.Quantity, sod.UnitID, sod.Weight, sod.WeightUnitID,
					soda.RefNo,
