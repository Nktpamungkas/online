							...
							<form id="form1" name="form1" method="post" action="?">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="normal9black">
									...
									<tr>
										...
										<td class="normal9black">
											<select name="dep0" class="normal9black" id="dep0" onChange="window.location='?subid='+this.value">
												<?php
												...
												?>
														<option value="<?= trim($row_option_group['CODE']) ?>" <?= trim($row_option_group['CODE']) == $subid ? 'selected' : '' ?>>
									...
									<tr>
										<td class="blod9black">Jenis Tanggal</td>
										<td class="normal9black">
											<select name="jenis_tanggal" class="normal9black">
												<option value="KK IN">KK IN</option>
												<option value="KK OUT">KK OUT</option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="blod9black">Range Tanggal </td>
										<td class="normal9black">
											<input type="time" class="normal9black" name="time1">
											<select name="tgldateDel" class="normal9black" id="tgldateDel">
											...
											Sampai
											<input type="time" class="normal9black" name="time2">
									...
									<tr>
										<td class="blod9black">&nbsp;</td>
										<td class="normal9black">
											<input name="button" type="submit" class="tombol" id="button" value="CARI DATA" />
										</td>
									</tr>
									<tr>
										<td class="blod9black">&nbsp;</td>
						...
						<td class="normal9black">
							...
							?>
								<span class='blod9black'>
									...
									<?= $dep0 ?>
									<br><br>
									Tanggal SCAN <?= $_POST['jenis_tanggal']; ?>:
								</span>
								<?= $_time1 . ' ' . $tglDisplay . " s.d " . $_time2 . ' ' . $tglDisplay2 ?>
								<span class='blod9black'>
									( Total Kartu Kerja : <?= $operation_row_count['JUMLAH'] ?>)
								</span><br><br>
								<font class='blod9black'>
									<a href="inoutkk0-xls.php?dep0=<?= $dep0 ?>&tglDel=<?= $tglDel ?>&tglDel2=<?= $tglDel2 ?>&time1=<?= $_time1 ?>&time2=<?= $_time2 ?>&jns_tgl=<?= $_POST['jenis_tanggal']; ?>" target="_blank" rel="noopener noreferrer">Excel</a>
								</font>
								<br><br>
								<table width='100%' border='0'>
									<thead>
									...
									<tbody>
										...
										?>
											<tr bgcolor="<?= $bgcolor ?>">
												...
												<td class="normal333" style="padding: 5px; vertical-align: top;"> <!-- KK IN -->
													<?php if($_POST['jenis_tanggal'] == 'KK IN') : ?>
														<?= date_format(date_create($row_operation['MULAI']), "Y-m-d H:i:s") ?>
													<?php elseif($_POST['jenis_tanggal'] == 'KK OUT') : ?>
														<?php
												...
												<td class="normal333" style="padding: 5px; vertical-align: top;"><!-- KK OUT -->
													<?php if($_POST['jenis_tanggal'] == 'KK IN') : ?>
														<?php
												...
												<td class="normal333" style="padding: 5px; vertical-align: top;"><!-- LAMA WAKTU -->
													<?php if($_POST['jenis_tanggal'] == 'KK IN') : ?>
														<?php
